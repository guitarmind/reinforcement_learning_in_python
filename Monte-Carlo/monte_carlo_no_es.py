...
def play_game(grid, policy):
    ...
    # but r(t) results from taking action a(t-1) from s(t-1) and landing in
    # s(t)
    ...
    for s, a, r in reversed(states_actions_rewards):
        ...
        # and ignore the last G, which is meaningless since it doesn't
...
if __name__ == '__main__':
    ...
    plt.plot(deltas)
    plt.savefig(f"{sys.argv[0][:-3]}.png")
    plt.show()
